  ...
  return (
    <section id="ai-search" className="mx-auto max-w-6xl px-6 py-24 sm:py-32">
      ...
      <div className="mt-14 grid gap-5 lg:grid-cols-2">
        ...
        <Reveal delay={0.1}>
          <div className="h-full rounded-2xl border border-line bg-white p-7 sm:p-8">
            <div className="flex items-center justify-between">
              <span className="label-mono text-muted/70">Google results</span>
            ...
            <div className="mt-6 rounded-xl border border-line bg-paper-warm p-4">
              <div className="flex items-center gap-2 rounded-full border border-line bg-white px-4 py-2.5">
                <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 text-muted/60" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className="mt-4 space-y-3.5">
                <div className="rounded-lg bg-white p-3.5 opacity-45">
                  <div className="h-2 w-1/3 rounded bg-line" />
                  <div className="mt-2 h-2.5 w-3/4 rounded bg-line" />
                </div>
                <div className="rounded-lg border border-accent/40 bg-white p-3.5 shadow-sm">
                  <p className="text-[10.5px] text-muted/70">summitcustompools.com</p>
                  <p className="mt-1 text-[13px] font-medium text-[#1a0dab]">
        ...
        {/* AI answer card */}
        <Reveal delay={0.2}>
          <div className="h-full rounded-2xl border border-line-dark bg-ink p-7 text-white sm:p-8">
            <div className="flex items-center justify-between">
              <span className="label-mono text-white/50">AI answer</span>
            ...
            <div className="mt-6 rounded-xl border border-line-dark bg-ink-soft p-4">
              ...
              <div className="mt-4 space-y-2.5 text-[12.5px] leading-relaxed text-white/80">
                <p>
                ...
                <span className="inline-flex items-center gap-1.5 rounded-full border border-white/15 px-2.5 py-1 text-[10.5px] text-white/60">
